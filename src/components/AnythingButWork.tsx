...
const cornerItems: CornerItem[] = [
  ...
  // NATHANIEL'S CORNER — FNF Mods (file-based via gn-math CDN)
  ...
  { id: 'fnf-bob', name: 'FNF vs Bob', icon: '😐', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/618.html', description: "Bob's Onslaught v2!", color: 'from-green-500 to-green-700', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/bob.png' },
  { id: 'fnf-sonic', name: 'FNF vs Sonic.EXE', icon: '🦔', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/601.html', description: 'Sonic.EXE 3.0/4.0!', color: 'from-blue-700 to-red-800', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/sonicexe.png' },
  { id: 'fnf-impostor', name: 'FNF vs Impostor V4', icon: '📮', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/608.html', description: 'Among Us crossover!', color: 'from-red-500 to-red-700', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/impostor.png' },
  { id: 'fnf-tabi', name: 'FNF vs Tabi', icon: '💀', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/714.html', description: 'Ex-boyfriend revenge!', color: 'from-gray-700 to-gray-900', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/tabi.png' },
  { id: 'fnf-zardy', name: 'FNF vs Zardy', icon: '🌽', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/715.html', description: 'Scarecrow showdown!', color: 'from-amber-700 to-green-900', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/zardy.png' },
  { id: 'fnf-dave', name: 'FNF vs Dave & Bambi', icon: '🌾', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/615.html-a', description: 'Dave & Bambi v3!', color: 'from-green-500 to-lime-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/dave-bambi.png' },
  { id: 'fnf-nonsense', name: 'FNF vs Nonsense', icon: '🤪', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/644.html', description: 'Pure chaos rap battle!', color: 'from-yellow-300 to-orange-400', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/nonsense.png' },
  { id: 'fnf-hypno', name: "FNF Hypno's Lullaby v2", icon: '😴', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/600.html', description: 'Creepy Pokémon mod!', color: 'from-yellow-600 to-purple-800', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/hypno.png' },
  { id: 'fnf-pibby', name: 'FNF Pibby Apocalypse', icon: '📺', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/541.html', description: 'Pibby corruption!', color: 'from-purple-700 to-gray-900', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/pibby.png' },
  { id: 'fnf-carol', name: 'FNF vs Carol V2', icon: '🎸', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/610.html', description: 'Rock out with Carol!', color: 'from-pink-500 to-red-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/carol.png' },
  { id: 'fnf-sunday', name: 'FNF vs Sunday HD', icon: '☀️', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/609-a.html', description: 'Sunday remastered HD!', color: 'from-orange-400 to-yellow-500', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/sunday.png' },
  { id: 'fnf-shaggy', name: 'FNF vs Shaggy', icon: '💪', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/559.html', description: 'God mode Shaggy!', color: 'from-yellow-500 to-green-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/shaggy.png' },
  { id: 'fnf-whitty', name: 'FNF vs Whitty', icon: '💣', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/474.html', description: 'Bomb-head showdown!', color: 'from-orange-600 to-red-700', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/whitty.png' },
  { id: 'fnf-tricky', name: 'FNF vs Tricky', icon: '🤡', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/481.html', description: 'Madness Combat clown!', color: 'from-red-600 to-gray-800', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/tricky.png' },
  { id: 'fnf-garcello', name: 'FNF vs Garcello', icon: '🚬', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/485.html', description: 'Chill ghost vibes!', color: 'from-purple-600 to-gray-800', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/garcello.png' },
  { id: 'fnf-hex', name: 'FNF vs Hex', icon: '🤖', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/476.html', description: 'Friendly robot rapper!', color: 'from-blue-500 to-cyan-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/hex.png' },
  { id: 'fnf-sky', name: 'FNF vs Sky', icon: '💙', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/556.html', description: 'Obsessed fangirl!', color: 'from-sky-400 to-blue-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/sky.png' },
  { id: 'fnf-kapi', name: 'FNF vs Kapi', icon: '🐱', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/555.html', description: 'Dance pad arcade cat!', color: 'from-orange-400 to-pink-500', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/kapi.png' },
  { id: 'fnf-bsides', name: 'FNF B-Sides Remix', icon: '🔵', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/475.html', description: 'B-Side remixes!', color: 'from-blue-600 to-indigo-700', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/bsides.png' },
  { id: 'fnf-dsides', name: 'FNF D-Sides', icon: '🔄', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/636.html', description: 'Alternate universe remix!', color: 'from-indigo-600 to-purple-700', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/dsides.png' },
  { id: 'fnf-indie', name: 'FNF Indie Cross', icon: '🎮', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/489.html', description: 'Cuphead x Sans x Bendy!', color: 'from-amber-500 to-red-600', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/infidelity.png' },
  { id: 'fnf-infidelity', name: "Wednesday's Infidelity", icon: '📅', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/616.html', description: 'Creepy Wednesday mod!', color: 'from-gray-800 to-red-900', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/infidelity.png' },
  { id: 'fnf-marios', name: "FNF Mario's Madness", icon: '🍄', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/582.html', description: 'Creepy Mario mod!', color: 'from-red-600 to-red-800', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/suicide-mouse.png' },
  { id: 'fnf-soft', name: 'FNF Soft', icon: '💛', url: 'https://cdn.jsdelivr.net/gh/gn-math/html@main/509.html', description: 'The soft mod!', color: 'from-yellow-400 to-pink-400', corner: 'nathaniel', thumbnail: '/games/fnf/thumbnails/sunday.png' },
